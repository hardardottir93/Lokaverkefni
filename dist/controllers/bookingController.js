import { cancelBooking, createBooking, getBookingById, getBookingsByUserId } from "../models/bookingModel.js";
...
export const getBookingsByUserIdController = async (request, response) => {
    const userId = response.locals.user.id;
...
export const cancelBookingController = async (request, response, next) => {
