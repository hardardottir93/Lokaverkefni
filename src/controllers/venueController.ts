...
export const getAllVenuesController = async (request: Request, response: Response) => {
...
export const getVenueByIdController = async (request: Request, response: Response) => {
